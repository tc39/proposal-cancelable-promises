...
function NewPromiseCapability(C) {
  ...
  if (IsCallable(promiseCapability.Resolve) === false) {
    throw new TypeError("The given constructor did correctly set a [[Resolve]] function on the promise capability");
  }
  if (IsCallable(promiseCapability.Reject) === false) {
    throw new TypeError("The given constructor did correctly set a [[Reject]] function on the promise capability");
  }
